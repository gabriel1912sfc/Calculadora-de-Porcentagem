...
function Subtract({onResult}){
    ...
    const calculate = (e) => {
      ...
      const res = f - s;
      onResult(`A subtração de ${f} e ${s} é ${res}`);
    };
  
    return (
      <form onSubmit={calculate}>
        <label>Digite o primeiro valor da subtração</label>
        <input
          type="number"
          value={firstValue}
        ...
        <label>Digite o segundo valor da Subtração</label>
        <input
          type="number"
          value={secondValue}
